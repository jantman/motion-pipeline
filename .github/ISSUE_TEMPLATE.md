...
motion-pipeline version, as reported by ``motion-pipeline --version``

### Installation Method

How was motion-pipeline installed (provide as much detail as possible, ideally
...
that motion-pipeline is running in, as well as your operating system type and version.

### Actual Output

```
Paste here the output of motion-pipeline (including the command used to run it),
