# -*- coding: utf-8 -*-
#
# motion-pipeline documentation build configuration file, created by
...
from motion_pipeline.version import VERSION
...
if is_rtd:
    ...
    htmlhelp_basename = 'motion-pipelinedoc'
...
latex_documents = [
  (master_doc, 'motion-pipeline.tex', u'motion-pipeline Documentation',
...
man_pages = [
    (master_doc, 'motion-pipeline', u'motion-pipeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'motion-pipeline', u'motion-pipeline Documentation',
   author, 'motion-pipeline', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/motion-pipeline'
]
